  ...
  return (
    <Dialog.Root open={open} onOpenChange={setOpen}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-1/2 left-1/2 z-50 max-h-[88vh] w-[min(94vw,920px)] -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-[var(--radius-xl)] border border-border bg-popover shadow-2xl">
                ...
                <div className="scrollbar-thin max-h-[508px] overflow-y-auto p-2">
                  ...
                  {search && !exact ? (
                    <button
                      ...
                      className="mb-2 flex w-full items-center gap-3 rounded-[var(--radius-md)] border border-primary bg-primary-subtle p-3 text-left text-primary-subtle-foreground"
                    >
                      <Plus className="size-4" />
                      <span>
                        Create{" "}
