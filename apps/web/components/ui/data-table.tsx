...
export function DataTable<TData, TValue>({
  ...
  React.useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- notify only when selection set changes
  }, [rowSelection]);
  ...
  return (
    <div className={cn("w-full", className)}>
      ...
      <div
        className={cn(
          // Prefer x-scroll only - overflow-hidden clips row action menus
          // when collision space is calculated against clipping ancestors.
